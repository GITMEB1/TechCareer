# CV Bullets: Tech Returners / Northcoders Application
...
### DATA ENGINEERING & AUTOMATION (The Pivot)
...
**Implementation Specialist** | 360insights | Jun 2023 – Nov 2023
- **Data Migration Quality:** Mitigated risk of data corruption during enterprise client onboarding by defining strict **CSV/JSON acceptance criteria**, resulting in low-defect go-lives.
- **API Integration Debugging:** Collaborated with engineering to diagnose and resolve **REST API** payload errors during live implementations, ensuring verified data integrity for client systems.

**Onboarding Lead / Technical Support** | Cloud Commerce Group | Jun 2013 – Nov 2022
- **Inventory Sync Stability:** Diagnosed and resolved complex distributed inventory sync failures (SQL-based diagnostics), stabilizing operations for high-volume retail clients.
- **Operational Rigour:** Authored internal **runbooks** and **SQL** scripts to standarise L2 support responses, reducing time-to-resolution for repetitive data incidents.
